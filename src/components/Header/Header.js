...
import shareButtonImage from "../../assets/image/svg/telegram.svg";
import twitterButtonImage from "../../assets/image/svg/twitter.svg";
import redditButtonImage from "../../assets/image/svg/reddit.svg";

const SVGItem = ({ src }) =>
  <img className="img-fluid" style={{ cursor: 'pointer', marginRight: 15 }} src={src} />;
const BuyButtonItem = () =>
  <div className="header-btns ml-auto ml-lg-0 d-none d-md-block">
    <a href="https://app.uniswap.org/#/swap?outputCurrency=0x14dd7ebe6cb084cb73ef377e115554d47dc9d61e" target="_blank" rel="noreferrer">
      <Button mb={2} color="black" bg="yellow" style={{ maxHeight: 55 }}>Buy</Button>
    </a>
  </div>
      ...
      >
        <Container fluid>
          <nav className="navbar site-navbar offcanvas-active navbar-expand-lg navbar-light">
            ...
            <EmptyFlex />
            <a href="https://t.me/ApeHaven" target="_blank" rel="noreferrer"><SVGItem src={shareButtonImage} /></a>
            <a href="https://twitter.com/ApeHaven" target="_blank" rel="noreferrer"><SVGItem src={twitterButtonImage} /></a>
            <a href="https://www.reddit.com/r/ApeHaven/" target="_blank" rel="noreferrer"><SVGItem src={redditButtonImage} /></a>
            <BuyButtonItem />
          </nav>
        </Container>
      </SiteHeader>
